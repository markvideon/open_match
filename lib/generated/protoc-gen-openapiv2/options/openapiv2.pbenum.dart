...
class Scheme extends $pb.ProtobufEnum {
  static const Scheme UNKNOWN = Scheme._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const Scheme HTTP = Scheme._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HTTP');
  static const Scheme HTTPS = Scheme._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HTTPS');
  static const Scheme WS = Scheme._(3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WS');
...
class SecurityScheme_Type extends $pb.ProtobufEnum {
  static const SecurityScheme_Type TYPE_INVALID = SecurityScheme_Type._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TYPE_INVALID');
  static const SecurityScheme_Type TYPE_BASIC = SecurityScheme_Type._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TYPE_BASIC');
  static const SecurityScheme_Type TYPE_API_KEY = SecurityScheme_Type._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TYPE_API_KEY');
  static const SecurityScheme_Type TYPE_OAUTH2 = SecurityScheme_Type._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TYPE_OAUTH2');
...
class SecurityScheme_In extends $pb.ProtobufEnum {
  static const SecurityScheme_In IN_INVALID = SecurityScheme_In._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IN_INVALID');
  static const SecurityScheme_In IN_QUERY = SecurityScheme_In._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IN_QUERY');
  static const SecurityScheme_In IN_HEADER = SecurityScheme_In._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IN_HEADER');
...
class SecurityScheme_Flow extends $pb.ProtobufEnum {
  static const SecurityScheme_Flow FLOW_INVALID = SecurityScheme_Flow._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOW_INVALID');
  static const SecurityScheme_Flow FLOW_IMPLICIT = SecurityScheme_Flow._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOW_IMPLICIT');
  static const SecurityScheme_Flow FLOW_PASSWORD = SecurityScheme_Flow._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOW_PASSWORD');
  static const SecurityScheme_Flow FLOW_APPLICATION = SecurityScheme_Flow._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOW_APPLICATION');
  static const SecurityScheme_Flow FLOW_ACCESS_CODE = SecurityScheme_Flow._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLOW_ACCESS_CODE');
